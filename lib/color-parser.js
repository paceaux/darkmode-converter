...
class ColorParser {
    static getColorSpace(cssColorValue) {
        const colorSpaceIterator = ColorParser.colorSpaceTests.entries();
        let colorSpaceName = '';

        // eslint-disable-next-line no-restricted-syntax
        for (const [colorSpace, expression] of colorSpaceIterator) {
            if (expression.test(cssColorValue)) {
